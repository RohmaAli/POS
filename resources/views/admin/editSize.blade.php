                                        ...
                                        <form action="{{route('editSize')}}" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input id="size-title" name="sizeTitle" type="text" class="form-control" value="{{$size->title}}">
                                                    <br>   
                                                    <label id="size" for="width">Width</label><br>
                                                    <input id="width" name="width" type="text" class="form-control" value="{{$size->width}}">
                                                    <br>  
