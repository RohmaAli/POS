                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Edit Daily Expense</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Ecommerce</a></li>
                                            <li class="breadcrumb-item active">Edit Daily Expense</li>
                                        </ol>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="size"> <b>Enter Expense Detail</b> </label><br>
                                                        <label id="size" for="size-title">Title</label><br>
                                                        <input id="size-title" name="title" type="text" class="form-control" value="{{$expense->title}}">
                                                        <br>   
                                                        <label id="size" for="width">Amount(pkr/-)</label><br>
                                                        <input id="width" name="amount" type="number" class="form-control" value="{{$expense->amount}}">
                                                        <br>
                                                        <label id="size" for="width">description</label><br>
                                                        <textarea name="description" id="width" cols="30" rows="5"class="form-control" >{{$expense->description}}</textarea>
                                                        <br>  
                                                    
                                                    </div>
                                                    <button type="submit" name="editExpense" class="form-control btn btn-primary mr-1 waves-effect waves-light" value="{{$expense->id}}">Save changes</button>
