                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                ...
                                <div class="col-xl-12">
                                                ...
                                                <div class="card-body">
                                                    <div class="media">
                                                        <div class="media-body">
                                                            ...
                                                            <h4 class="mb-0">{{$total_quantity_sold}}</h4>
                                                        </div>
                                    ...
                                    <!-- end row -->
                                    <form action="{{route('datewiseReport')}}" method="post">
                                    @csrf
                                    <h4><center>Select Date</center> </h4>
                                    <div class="form-group">
                                
                                        <label for=""> From</label>
                                        <select name="from"  class="form-control" id="size">  
                                        @foreach($dates as $date)    
                                            <option value="{{$date}}">{{$date}}</option>  
                                        @endforeach       
                                        </select> <br>  
                                        <label for=""> Till</label>
                                        <select name="till"  class="form-control" id="size"> 
                                        @foreach($dates as $date)     
                                            <option value="{{$date}}">{{$date}}</option> 
                                        @endforeach        
                                        </select>
