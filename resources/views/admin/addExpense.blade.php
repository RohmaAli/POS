                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Daily Expense</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="size-title" name="title" type="text" class="form-control">
                                                        <br>   
                                                        <label id="size" for="width">Amount</label><br>
                                                        <input id="width" name="amount" type="number" class="form-control">
                                                        <br>
                                                        <label id="size" for="width">description</label><br>
                                                        <textarea name="description" id="width" cols="30" rows="10"class="form-control"></textarea>
                                                        <br>  
                                                    
                                                    </div>
                                                    <button type="submit" name="addExpense" class="form-control btn btn-primary mr-1 waves-effect waves-light" >Save changes</button>
