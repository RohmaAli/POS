...
<!-- ============================================================== -->
         ...
         -->
                                        <form action="{{route('expenseActions')}}" method="post">
                                            @csrf
                                            <button type="submit" name="addexpense" class="btn btn-primary mr-1 waves-effect waves-light" value="1"><i class="fa fa-plus"></i> Add Expense</button>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-centered table-nowrap">
                                                ...
                                                @foreach($dailyexpenses as $dailyExpense)
                                                    <tr>
                                                        <td>{{$dailyExpense->id}}</td>
                                                        <td>{{$dailyExpense->title}}</td>
                                                        <td>{{$dailyExpense->amount}}</td>
                                                        <td>{{$dailyExpense->description}}</td>
                                                       
                                                        <td>
                                                        <button class="btn" name="edit" value="{{$dailyExpense->id}}"><i class="fa fa-edit"></i></button>
                                                        <button class="btn" name="delete" value="{{$dailyExpense->id}}"><i class="fa fa-trash"></i></button>
                                                        </td>
                                                    </tr>
                                                @endforeach
