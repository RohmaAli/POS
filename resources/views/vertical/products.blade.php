...
<!-- ============================================================== -->
         ...
         -->
                                        <form action="{{route('productActions')}}" method="post">
                                            @csrf
                                            <button type="submit" name="addProduct" class="btn btn-primary mr-1 waves-effect waves-light" value="1"><i class="fa fa-plus"></i> Add Product</button>
                                            ...
                                            <table class="table table-centered table-nowrap">
                                                ...
                                                @foreach($products as $product)
                                                    <tr>
                                                        ...
                                                        <button class="btn" name="delete" value="{{$product->id}}"><i class="fa fa-trash"></i></button>
                                                        </td>
                                                    </tr>
                                                @endforeach
